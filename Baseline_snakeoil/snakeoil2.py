    ...
    def get_servers_input(self):
        ...
        while True:
            ...
            if '***identified***' in sockdata:
                ...
                print (f"Server has stopped the race on {self.port}. You were in {self.S.d['racePos']} place.") 
                self.shutdown()
                return
            elif '***restart***' in sockdata:
                # What do I do here?
                print("Server has restarted the race on {self.port}.")
