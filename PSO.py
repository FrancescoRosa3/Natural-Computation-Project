...
if __name__ == '__main__':
    ...
    PARAMETERS_STRING = f"{np_seed}_{swarm_size}_{iterations}_{n_parameters}_{options['c1']}_{options['c2']}_{options['w']}__{options['k']}_{options['p']}_{PERCENTAGE_OF_VARIATION}_{change_cond_version}"
